...
second-order logic \citep{Karp1964a}. The typed abstract syntax representation
of such model would be infinite because of the switches that generate
...
\caption{\label{figSigSem} Translation of signals.}
