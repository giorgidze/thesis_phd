...
addition and removal of equational constraints, at discrete points in time,
have already been introduced (see the work-in-progress report by
\citet{Taha2011a} for details). In this new version of Acumen, a model is
simulated through interpretation. Because, in Acumen, a noncausal model is
converted into a flat list of differential equations for numerical simulation
purposes, it is feasible to integrate the JIT compilation approach described
in this thesis in the implementation of Acumen.
